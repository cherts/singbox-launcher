...
3. Если `tag_mask` не указан:
   - Применяется `tag_prefix` (если указан) с подстановкой переменных: `"1:🇷🇺 Moscow"` или `"source1-🇷🇺 Moscow"`
   - Применяется `tag_postfix` (если указан) с подстановкой переменных: `"1:🇷🇺 Moscow--xx"` или `"source1-🇷🇺 Moscow--xx"`
