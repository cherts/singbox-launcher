...
2. Применяется `tag_prefix` (если указан): `"source1-🇷🇺 Moscow"`
3. Применяется `tag_postfix` (если указан): `"source1-🇷🇺 Moscow--xx"`
...
Если узел имел тег `"🇷🇺 Moscow"`, итоговый тег будет `"source1-🇷🇺 Moscow--xx"`.
